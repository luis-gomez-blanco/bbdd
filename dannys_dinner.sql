...
CREATE DATABASE IF NOT EXISTS `dannys_dinner` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
USE `dannys_dinner`;
...
-- Volcando datos para la tabla dannys_dinner.menu: ~3 rows (aproximadamente)
DELETE FROM `menu`;
...
-- Volcando datos para la tabla dannys_dinner.miembro: ~3 rows (aproximadamente)
DELETE FROM `miembro`;
